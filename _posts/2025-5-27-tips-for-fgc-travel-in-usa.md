---
title:  "Personal Tips & Tricks for FGC Travel in the United States"
layout: post
excerpt: ""
---
...
[@geoffEXE](https://twitter.com/geoffEXE) has an incredible guide for [FGC Travel](https://docs.google.com/document/d/1KaoLmuwnvoipnDPULhJ37CWfsO4_5_V0WDOvWGi_5NE) in general, and I wanted to share some of my own tips and expand on some of his from my own experiences. This post assumes:
...
1. [TSA Pre-check](#tsa-pre-check)
    1. [How do I get it?](#how-do-i-get-it)
    2. [Can I go through regular TSA and still get pre-check treatment?](#can-i-go-through-regular-tsa-and-still-get-pre-check-treatment)
    3. [What's the deal with REAL ID?](#whats-the-deal-with-real-id)
2. [Airlines and the flight itself](#airlines-and-the-flight-itself)
    1. [Airlines of choice](#airlines-of-choice)
    2. [Bags and you](#bags-and-you)
    3. [Controllers in checked luggage](#controllers-in-checked-luggage)
    4. [Killing time on the flight](#killing-time-on-the-flight)
    5. [Sleeping en route](#sleeping-en-route)
3. [Hotels and supplies](#hotels-and-supplies)
    1. [Choosing a hotel](#choosing-a-hotel)
    2. [Things you might want to buy on arrival](#things-you-might-want-to-buy-on-arrival)
    3. [Things the hotel has for you and things you shouldn't pack](#things-the-hotel-has-for-you-and-things-you-shouldnt-pack)
    4. [Keeping yourself going through the day](#keeping-yourself-going-through-the-day)
4. [Setup tech and you](#setup-tech-and-you)
    1. [What to expect from the average hotel room](#what-to-expect-from-the-average-hotel-room)
    2. [Outlets for your setups](#outlets-for-your-setups)
    3. [My personal tech setup](#my-personal-tech-setup)
    4. [Setups on a budget](#setups-on-a-budget)
    5. [Other notes on setups](#other-notes-on-setups)
5. [Odds and Ends](#odds-and-ends)
    1. [Room population option select (traveling by car only, optional)](#room-population-option-select-traveling-by-car-only-optional)
    2. [Personal fitness and health for events](#personal-fitness-and-health-for-events)
...
Laptop backpacks from brands like Case Logic are really good personal items; they’ve got a dedicated laptop pocket, a tablet pocket you can repurpose as a portable charger pocket, large capacity per pocket, lots of smaller pockets for things like hand sanitizer, and so on. I recently picked up a [tomtoc 40 Liter Travel Backpack](https://www.amazon.com/dp/B097P4JVP7) on recommendation from a coworker; it’s a backpack that’s as close to a second carry-on as possible.
...
The rule for whether or not you can put something electronic in your luggage usually boils down to “does it have a large enough lithium ion (li-ion) battery inside?” I have an electric toothbrush with a li-ion battery and [that’s considered within regulations](https://www.tsa.gov/travel/security-screening/whatcanibring/items/electronic-toothbrush) according to TSA. When in doubt, TSA publishes a [“What can I bring?”](https://www.tsa.gov/travel/security-screening/whatcanibring/all) list. [You would](https://www.tsa.gov/travel/security-screening/whatcanibring/items/ammunition) [be surprised](https://www.tsa.gov/travel/security-screening/whatcanibring/items/antlers) [what you](https://www.tsa.gov/travel/security-screening/whatcanibring/items/crowbars) [can and can’t bring](https://www.tsa.gov/travel/security-screening/whatcanibring/items/full-sized-video-game-consoles).
...
If you’re flying alone, bring something to do that’s not disruptive. I bring my Steam Deck or my [Miyoo Mini Plus](https://www.keepretro.com/products/miyoo-mini-plus?variant=44192801456290), sometimes a physical book, sometimes my [Kobo Clara](https://us.kobobooks.com/products/kobo-clara-bw). I’ve found that books & handhelds are usually the best options for killing time on flights: if it doesn’t need an internet connection, it’s golden.
...
I have noise-cancelling earbuds, which are really nice if you can afford them (from a brand like Sony or Bose). If you have regular earbuds, you can try using them in conjunction to drown out any noise, but you may want to invest in actual earplugs. When I used to swim a lot, I got [Mack’s Silicone Putty Earplugs](https://www.amazon.com/Macks-Pillow-Soft-Silicone-Earplugs/dp/B00SYEHC64) and they actually do what they say on the tin really well.

Someone’s gonna say it to you eventually so I might as well get it out of the way: yeah, you can talk to your doctor and get a [benzo](https://www.dea.gov/factsheets/benzodiazepines) prescription, but save getting xan’d out for the 13~16 hour flight to Japan if you ever go to EVO Japan. A few hours going around the US shouldn’t require drugs; JFK to O’Hare is roughly 2 hours and change. [This Reddit thread should kinda cover everything in this subject](https://www.reddit.com/r/travel/comments/14qcjpe/has_anyone_tried_prescription_sleeping_pills_on/) but if you can lock in for a fighting game, you can lock in for a flight without a benzo.
...
However, sometimes you don’t have that kind of availability. I recommend using [Hotels.com](https://www.hotels.com/) (child company of Expedia) to vet any hotels in the area, see previews of the rooms and their layout, and save a few bucks when booking rooms.
...
Just to get this out of the way since this is an epidemic: **you should always bring deodorant**. I would even recommend an “anti-gamer” hygiene kit that my friend [Dr.00](https://x.com/Dr00_PhD) came up with that consists of a regular deodorant stick or 2 travel sized ones, hygiene wipes ([something similar to this](https://www.amazon.com/Wet-Ones-Sensitive-Moist-Travel/dp/B00JGQO1T0)), and I would probably toss in some travel tissues to clean the deodorant stick(s). Keep yourself and the team fresh.
...
Some people have that ***dawg*** in ’em where they’ll just power through the day [and then eat a big meal](/assets/images/discord_k2jdq5uye7.png) at like midnight or something. I think it’s pretty important to pace yourself and make sure you’re still eating and hydrating decently. Consider that you’re likely going to be waking up early for the venue even if your pools are really late.

Outside of water, I pack “rations” for each day of the event if I can. I tend to pick from the following:

- “Protein” bars that lean more towards the food side, like [CLIF](https://www.amazon.com/CLIF-BAR-Variety-Organic-Protein/dp/B07D83162X) and [Nature Valley](https://www.amazon.com/Nature-Valley-Peanut-Chocolate-Protein/dp/B06XJTCM38)
- Either nuts (biasing more towards almonds, cashews, Brazil nuts) or trail mix ([this Costco/Kirkland brand](https://www.costco.com/kirkland-signature-trail-mix-snack-packs%2c-2-oz%2c-28-count.product.100770569.html) is my favorite for taste/price/nutritional value)
- Beef/Turkey jerky
- Monster Zero Ultra as my end-of-day stimulant (my favorite is “White Sip” [for those in the know](https://i.kym-cdn.com/photos/images/original/001/716/052/bda.png))
...
- Power strip (the Amazon Basics brand works well, I have the Anker [Power Cube](https://www.amazon.com/dp/B09PGZHCXR) and use this)
- Extension cord (something like [this](https://www.amazon.com/GE-Extension-Grounded-Low-Profile-50251/dp/B000FBPP8G), [this](https://www.amazon.com/GE-Designer-Extension-Protection-38433/dp/B073R2D51S), or [this](https://www.amazon.com/Cruise-Essentials-Extension-Extender-Protector/dp/B0BWY8FBFP))
...
As of May 2025, I'm running the Steam Deck setup I outline below in *[Setups on a budget](#setups-on-a-budget)*. I've found that it's good for Street Fighter 6, Fatal Fury City of the Wolves, any party game I throw at it, and streaming from my Plex server.

If I do decide to go with another laptop, I’m likely eyeing the [Razer Blade 14](https://www.razer.com/gaming-laptops/razer-blade-14?page=tech-specs). I’m not a huge fan of Razer products because I remember what Razer used to be like back in my FPS days where they made a lot of inferior or useless schlock outside of the Deathadder. However, their quality of products has slowly gone up over the years and after talking with a coworker who uses one for work and play, I’ve found it fits this use case perfectly.

Additionally, at Combo Breaker 2025, I saw someone with the [Asus Zephyrus G14](https://www.bestbuy.com/product/asus-rog-zephyrus-g14-14-oled-3k-120hz-gaming-laptop-amd-ryzen-9-8945hs-16gb-lpddr5x-nvidia-geforce-rtx-4060-1tb-ssd-platinum-white/JJGGLRWZX4?cmp=RMX) and it’s just as small as the Razer Blade. It worked perfectly for sitting between stations on a Saturday night/Sunday when the setups were being packed up but there were still some tables around. The G14 has some pretty beefy specs but the RAM is soldered onto the device; if the RAM goes, you will be on a support call with Asus.
...
Valve announced the [Steam Machine](https://store.steampowered.com/sale/steammachine) on November 11th, 2025. It's a 6" cube with midrange desktop power and it'll likely change the gaming hardware game on multiple fronts, possibly even fighting games. It's still a ways off, slated for release in Early 2026, but keep it in mind.
...
- [The Steam Deck](https://store.steampowered.com/steamdeck) (The 256gb LCD is $400)
- [UGREEN’s aftermarket Steam Deck Dock](https://www.amazon.com/UGREEN-Docking-Foldable-Ethernet-Compatible/dp/B0CR6JND4M)
- [ARZOPA’s 16″ 144hz portable monitor](https://www.amazon.com/dp/B0CH9WTW56?psc=1)
- ~~Baseus’ 20k mAH 65w power bank~~ [Anker's 20k mAH 87w power bank](https://www.amazon.com/Anker-Portable-Charger-Charging-Battery/dp/B0CXDXP8VR) since the Baseus is no longer in production
...
- ~~Anker’s 100 watt “Prime” charger (Model # – A2688)~~ [Anker's 100 watt Charger](https://www.amazon.com/Anker-Charger-Ultra-Compact-Displayand-Non-Battery/dp/B0FB8QB54F) (Model # - B121B)
- [Rii K06 Mini Bluetooth Keyboard](https://www.amazon.com/dp/B0BML42L6X)
...
Something I’ve seen and even tried myself is using the Intel-designed [NUC (Next Unit of Computing)](https://en.wikipedia.org/wiki/Next_Unit_of_Computing). If you buy a powerful-enough/gaming focused NUC, you can run most fighting games with ease and use it as a BYOC setup, but the issue will always come down to the pricetag; ASUS took over production of NUCs once Intel stopped producing the computers themselves, and as part of their gaming lineup, ASUS has made two NUCs with Nvidia 4xxx series chips in them. The middle-end NUCs that people use as desktop substitutes for office work and streaming aren’t great for anything beyond Guilty Gear +R and Fightcade.

If you’d like to stream and you have a console with you, rather than forking over $175 + shipping & handling for an Elgato capture card, I’d recommend scooping [EVGA’s XR1 Lite](https://www.evga.com/products/product.aspx?pn=141-U1-CB20-LR). You won’t be doing 4k streaming or anything crazy with the XR1 Lite, but it does what it needs to do perfectly and works with OBS out of the box without any fuss. Whether or not you’ll actually be able to stream on a hotel connection may vary but it’s also nice for doing plain old video capture from a console so you can save the offline sessions.

Hotels are phasing out ethernet jacks existing in hotel rooms, but another item you *may* want to consider is a cheap ethernet switch, I have [this one from TP-Link](https://www.amazon.com/gp/product/B00A128S24). If you have multiple setups and access to an ethernet jack, it’s a good way to give multiple devices a stable albeit slow connection to the internet. Whether or not an ethernet switch is effective even if an ethernet jack exists in the room is also dependent on the room’s layout.
...
I have two twin-size [Intex Electric Air Mattresses](https://www.amazon.com/dp/B0869D64HL/?th=1) in the 18″ configuration, which is just a few inches shorter than your typical hotel room bed. The 13″ configuration is pretty low to the ground like if you tossed a regular old mattress on the floor. There’s a price difference between the two.

To go with them, I also have:

- [Cheap sheets](https://www.amazon.com/gp/product/B014I8B3LE) (easy to wash, easy to store, easy to throw out if necessary)
- [Camping pillow](https://www.amazon.com/gp/product/B07C83BCLK)
- [Cheap microfiber throw](https://www.amazon.com/Bedsure-Fleece-Blanket-Lightweight-Microfiber/dp/B0157T2C3G) (make sure you get the twin size)
